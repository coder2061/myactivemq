...
public class MQConsumer {
	...
	private static void receiveMsg(MessageConsumer consumer, long timeout) throws JMSException {
		while (true) {
	...
	private static void closeAll(MessageConsumer consumer, Session session, Connection connection) {
